...
const features = [
  ...
  },
  {
    ...
    titleKey: 'features.creativeCaptions.title',
    descriptionKey: 'features.creativeCaptions.description',
  },
  {
    icon: MousePointer,
...
const useCases = [
  ...
  {
    icon: ShoppingBag,
    titleKey: 'useCases.contentCreation.title',
    descriptionKey: 'useCases.contentCreation.description',
  },
  {
    icon: Share2,
