...
const features = [
  {
    icon: Maximize,
    color: 'text-blue-500',
    titleKey: 'features.advancedAI.title',
    descriptionKey: 'features.advancedAI.description',
  },
  {
    icon: Zap,
    color: 'text-yellow-500',
    titleKey: 'features.highResolution.title',
    descriptionKey: 'features.highResolution.description',
  },
  {
    icon: MousePointer,
    color: 'text-green-500',
    titleKey: 'features.quickProcessing.title',
    descriptionKey: 'features.quickProcessing.description',
  },
  {
    icon: DollarSign,
    color: 'text-purple-500',
    titleKey: 'features.freeTool.title',
    descriptionKey: 'features.freeTool.description',
  }
]
...
const useCases = [
  {
    icon: Camera,
    titleKey: 'useCases.familyPhotos.title',
    descriptionKey: 'useCases.familyPhotos.description',
  },
  {
    icon: ShoppingBag,
    titleKey: 'useCases.historicalImages.title',
    descriptionKey: 'useCases.historicalImages.description',
  },
  {
    icon: Share2,
    titleKey: 'useCases.artProjects.title',
    descriptionKey: 'useCases.artProjects.description',
  },
  {
    icon: PieChart,
...
export default function PhotoColorizerContent() {
  const t = useTranslations('Index.PhotoColorizerContent')
  ...
  return (
    <div className="bg-background text-foreground">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="mt-8">
              <Button size="lg">{t('colorizeButton')}</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <p>{t('colorizationParagraph1')}</p>
            <p>{t('colorizationParagraph2')}</p>
          </div>
