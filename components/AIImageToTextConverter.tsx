...
export default function AIImageToTextConverter() {
  const t = useTranslations('Index.AIImageToTextConverter')
        ...
        <CardContent className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                {isProcessing ? t('processingButton') : t('extractTextButton')}
              </Button>
      ...
      <div className="w-full lg:flex-1 bg-background flex flex-col justify-start items-center p-6 space-y-6">
        ...
        <div className="w-full max-w-xl">
          <div className="flex justify-between items-center mb-2">
            <h3 className="text-lg font-semibold">{t('extractedTextTitle')}</h3>
            <Button
              variant="outline"
              size="sm"
          ...
          <Textarea
            value={extractedText}
            readOnly
            placeholder={error || t('extractedTextPlaceholder')}
