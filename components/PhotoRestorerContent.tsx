...
const features = [
  {
    icon: Maximize,
    color: 'text-blue-500',
    titleKey: 'features.restoreDamage.title',
    descriptionKey: 'features.restoreDamage.description',
  },
  {
    icon: Zap,
    color: 'text-yellow-500',
    titleKey: 'features.colorEnhancement.title',
    descriptionKey: 'features.colorEnhancement.description',
  },
  {
    icon: MousePointer,
    color: 'text-green-500',
    titleKey: 'features.automaticRestoration.title',
    descriptionKey: 'features.automaticRestoration.description',
  },
  {
    icon: DollarSign,
...
const useCases = [
  {
    icon: Camera,
    titleKey: 'useCases.familyMemories.title',
    descriptionKey: 'useCases.familyMemories.description',
  },
  {
    icon: ShoppingBag,
  ...
  {
    icon: PieChart,
    titleKey: 'useCases.gifts.title',
    descriptionKey: 'useCases.gifts.description',
  }
]

export default function PhotoRestorerContent() {
  const t = useTranslations('Index.PhotoRestorerContent')
      ...
      <section className="py-16 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8">
            {t('photoRestorationTitle')}
          </h2>
          <div className="space-y-6">
            <p>{t('photoRestorationParagraph1')}</p>
            <p>{t('photoRestorationParagraph2')}</p>
          </div>
