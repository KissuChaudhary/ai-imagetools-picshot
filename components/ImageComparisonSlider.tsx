...
import { ArrowLeftRight, Zap, Maximize, MousePointer, DollarSign, Upload, Sliders, Download, Camera, ShoppingBag, Share2, PieChart, ChevronDown } from 'lucide-react'
...
const features = [
  ...
  },
  {
    ...
    titleKey: 'features.userFriendly.title',
    descriptionKey: 'features.userFriendly.description',
  },
  {
    icon: DollarSign,
...
const steps = [
  ...
  {
    icon: Sliders,
    titleKey: 'steps.chooseLevel.title',
    descriptionKey: 'steps.chooseLevel.description',
    image: '/placeholder.svg?height=200&width=300'
  },
  {
    icon: Download,
...
const useCases = [
  {
    icon: Camera,
    titleKey: 'useCases.photography.title',
    descriptionKey: 'useCases.photography.description',
  },
  {
    icon: ShoppingBag,
  ...
  {
    icon: Share2,
    titleKey: 'useCases.personalUse.title',
    descriptionKey: 'useCases.personalUse.description',
  },
  {
    icon: PieChart,
    titleKey: 'useCases.businessPresentations.title',
    descriptionKey: 'useCases.businessPresentations.description',
  }
]

export default function ImageComparisonSlider() {
  const t = useTranslations('Index.ImageComparisonSlider')
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-8">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="mt-8">
              <Button size="lg">{t('upscaleButton')}</Button>
            </div>
          </div>
        </div>
      </section>
