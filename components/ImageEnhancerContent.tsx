...
const features = [
  {
    icon: Maximize,
    color: 'text-blue-500',
    titleKey: 'features.upscaleResolution.title',
    descriptionKey: 'features.upscaleResolution.description',
  },
  {
    icon: Zap,
    color: 'text-yellow-500',
    titleKey: 'features.clarityBoost.title',
    descriptionKey: 'features.clarityBoost.description',
  },
  {
    icon: MousePointer,
    color: 'text-green-500',
    titleKey: 'features.hdOutput.title',
    descriptionKey: 'features.hdOutput.description',
  },
  {
    icon: DollarSign,
...
export default function ImageEnhancerContent() {
  const t = useTranslations('Index.ImageEnhancerContent')
  ...
  return (
    <div className="bg-background text-foreground">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="mt-8">
              <Button size="lg">{t('enhanceImageButton')}</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <p>{t('imageEnhancementParagraph1')}</p>
            <p>{t('imageEnhancementParagraph2')}</p>
          </div>
